...
<img src="./pic/L5-10.jpg" width="70%">
...
在实践中，![](http://latex.codecogs.com/svg.latex?\frac{df}{d\theta})是对神经网络取梯度，需要一次反向传播。
...
即最优解![](http://latex.codecogs.com/svg.latex?b^*=\frac{\mathbf{E}[g(\tau)^{2}r(\tau)]}{\mathbf{E}[g(\tau)^2]})
